...
public class palsquareTester {
	public static void main(String[] args) throws IOException {
		...
		/*
		 * for (int i = 1; i<= 300; i++) { String base = convertBase(i, x); int basei =
		 * Integer.parseInt(base); String sq = Integer.toString((int) Math.pow(basei,
		 * 2)); if (isPal(sq)) { out.println(base + " " + sq); } }
		 */
